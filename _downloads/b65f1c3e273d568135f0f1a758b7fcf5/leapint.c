...
void leapstep(x, v, n, dt) double x[]; /* positions of all points  */
...
void accel(a, x, n) double a[]; /* accelerations of points  */
...
void printstate(x, v, n, tnow) double x[]; /* positions of all points  */
double v[];                                /* velocities of all points */
int n;                                     /* number of points         */
